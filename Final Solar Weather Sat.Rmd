...
###Visualize Sunshine Percent and Cloud Cover Percent graphed together on one graph
```{r}
...
We expected to see the solar production data from the 2 panels at NYPA's White Plain office to be highly dependent on weather, both the intensity of the solar radiation on the panels represented in this data set as sunshine minutes and also the cloud cover percentage. 
